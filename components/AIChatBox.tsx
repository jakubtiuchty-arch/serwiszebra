    ...
    return (
      <div className="flex flex-col justify-center flex-1 min-h-0 px-4 pb-safe" style={{ paddingBottom: 'max(env(safe-area-inset-bottom, 0px), 8px)' }}>
              ...
              {loading && (
                <div className="flex gap-2 items-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Diagnozuję {detectedDevice.possessive} {detectedDevice.name}...
                  </p>
                </div>
              )}
        ...
        <div className="pb-4 pt-3 flex-shrink-0 -mx-4 px-4">
          ...
          {/* Badge modelu — bez numeru wersji (zmienia się częściej niż strona) */}
          <div className="flex items-center justify-center mt-2">
            <div className="flex items-center gap-1.5 px-2 py-0.5 bg-white/70 rounded-full border border-gray-200">
              ...
              <span className="text-[11px] font-medium text-gray-800">ChatGPT</span>
            </div>
          </div>
          <style jsx>{`
            @keyframes shimmer {
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex justify-center mt-3">
        <div className="flex items-center gap-1.5 px-2.5 py-1 bg-gray-50 rounded-full border border-gray-200">
          ...
          <span className="text-xs font-medium text-gray-800 tracking-tight">ChatGPT</span>
        </div>
      </div>
    </div>
  )
