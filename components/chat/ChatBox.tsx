      ...
      <form onSubmit={handleSendMessage} className="border-t border-gray-200 p-2 bg-white flex-shrink-0">
        ...
        <div className="flex gap-1.5">
          ...
          <button
            ...
            className="px-2 py-1.5 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          ...
          >
            {sending ? (
              <div className="flex items-center gap-1.5">
                ...
                {uploading && <span className="text-xs">Wysyłam...</span>}
              </div>
            ) : (
              <>
                <Send className="w-4 h-4" />
                <span className="text-sm font-semibold hidden sm:inline">Wyślij</span>
              </>
            )}
          </button>
        </div>
