# Instrukcja obsługi drukarki Zebra ZD230d

**Drukarka termiczna bezpośrednia (Direct Thermal) – z opcjami sieciowymi**
...
#### Przypisanie statycznego IP (przez komendy ZPL):

```
! U1 setvar "internal_wired.ip.protocol" "permanent"
! U1 setvar "internal_wired.ip.addr" "xxx.xxx.xxx.xxx"
! U1 setvar "internal_wired.ip.netmask" "255.255.255.0"
! U1 setvar "internal_wired.ip.gateway" "xxx.xxx.xxx.xxx"
```

Po zmianie wykonaj reset sieci lub uruchom drukarkę ponownie.
