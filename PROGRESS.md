...
- Poprawka wyglądu 5.09 (uwaga użytkownika: „wygląda dramatycznie"): sekcja na stronie głównej miała listy podkreślonych kodów w każdym kafelku i puste kafelki przy klasach z 3 modelami. Teraz kafelki jak na hubie (grafika, nazwa, liczba modeli, zajawka, serie) i jeden indeks modeli pod spodem (klasa → modele po przecinku). 26 linków do kart zostaje. Commit 8c06b45.
