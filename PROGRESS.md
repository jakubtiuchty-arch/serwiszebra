...
- Ten sam zabieg dla „Co naprawiamy": arkusz 2×2 (drukarka ZD z etykietą, terminal z klawiaturą, skaner pistoletowy z wiązką, tablet z ptaszkiem) → `public/icons/line/urzadzenie-{drukarka,terminal,skaner,tablet}.png`, 40 px w szarym boxie. Zielone „ptaszki" przy punktach listy zostały (CheckCircle2 z lucide) — do wymiany przy następnym podejściu, jeśli będą razić.
