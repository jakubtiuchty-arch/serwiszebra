...
- Poprawka wyglądu 5.09 (uwaga użytkownika: „wygląda dramatycznie"): sekcja na stronie głównej miała listy podkreślonych kodów w każdym kafelku i puste kafelki przy klasach z 3 modelami. Teraz kafelki jak na hubie (grafika, nazwa, liczba modeli, zajawka, serie) i jeden indeks modeli pod spodem (klasa → modele po przecinku). Commit 8c06b45 — użytkownik: „jeszcze gorzej". Decyzja (pytanie z opcjami): same 4 kafelki, bez listy modeli — commit a13d065. Linki do 26 kart zostają na hubie, w stopce, na blogu i w instrukcjach. Nauczka: przy uwagach o wyglądzie pytać, nie zgadywać trzeci raz.
