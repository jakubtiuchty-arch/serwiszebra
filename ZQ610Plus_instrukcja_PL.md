# Instrukcja obsługi drukarki Zebra ZQ610 Plus

**Mobilna drukarka etykiet 2-calowa**
...
| Wymiary | 91,4 x 170,9 x 72,4 mm | 91,4 x 170,9 x 72,4 mm |
...
| Maks. średnica rolki | 55,8 mm | 66,8 mm | 66,8 mm |
...
- Wi-Fi 6 dual radio (802.11ax + Bluetooth 5.3) lub
- Wi-Fi 5 dual radio (802.11ac + Bluetooth 4.2) (opcje)
- Bluetooth 4.2 Classic + BLE (opcja samo radio)
- Ethernet 10/100 (przez stację dokującą)
- NFC (Near Field Communication)

### Cechy charakterystyczne

- **Wi-Fi 6 i Bluetooth 5.3** – najnowsze standardy łączności bezprzewodowej
...
| 🔋 | Poziom naładowania baterii (4 poziomy) |
| ⚡ | Ładowanie w toku |
| 📄 | Status mediów (miga czerwono = brak) |
| ⚠️ | Błąd (miga czerwono) |
| 🔓 | Pokrywa otwarta (miga czerwono) |
| 🌐 | Ethernet podłączony (w stacji dokującej) |
...
|-------|------|-----------|
| ⚙️ | **Settings** | Ciemność druku, typ mediów, tryb druku, szerokość |
...
> **Aby wyłączyć tryb Peel-Off:** otwórz pokrywę i naciśnij ramię peelera w dół aż zatrzaśnie się w pozycji wyjściowej.

---

## 5. Ładowanie i zarządzanie baterią
...
- Używaj handshakingu programowego (XON/XOFF) gdy to możliwe
- Wyjmuj baterię jeśli drukarka nie jest używana przez dłuższy czas

---

## 6. Łączność bezprzewodowa
...
| Rozstaw otworów montażowych | 58,928 mm (2,32") |
