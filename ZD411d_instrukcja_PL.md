# Instrukcja obsługi drukarki Zebra ZD411d

**Drukarka termiczna bezpośrednia 2-calowa – seria Link-OS**
...
| Rozdzielczość | 203 dpi (8 dots/mm) lub 300 dpi (12 dots/mm) |
...
3. Wskaźniki LED będą migać podczas uruchamiania
4. Gdy wskaźnik STATUS zaświeci na zielono – drukarka gotowa
...
Po załadowaniu nowego typu materiału:
...
Pobierz **Zebra Setup Utilities** lub **Windows Printer Driver v8** ze strony: [zebra.com/zd411d-info](https://zebra.com/zd411d-info)
...
4. W razie potrzeby przetrzyj wacikiem nasączonym alkoholem
...
Drukarka posiada wbudowany zegar z baterią o żywotności ok. 10 lat. Bateria nie jest wymienialna przez użytkownika – w razie potrzeby skontaktuj się z serwisem.
...
4. Jeśli błąd się powtarza – skontaktuj się z serwisem
...
Temperatura otoczenia jest zbyt niska. Przenieś drukarkę w cieplejsze miejsce i poczekaj aż się nagrzeje.

### Błąd rozdzielczości głowicy

Drukarka nie może odczytać typu głowicy. Sprawdź czy głowica jest prawidłowo zainstalowana. Używaj tylko oryginalnych głowic Zebra.

### Drukarka nie reaguje

1. Sprawdź połączenie zasilania
2. Sprawdź połączenie danych (USB/sieć)
3. Zrestartuj drukarkę (wyłącz na 10 sekund)
4. Sprawdź kolejkę druku w systemie
