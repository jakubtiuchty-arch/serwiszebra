              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    <tr className="bg-[#A8F000]/10"><td className="p-3 sm:p-4 font-medium text-gray-900">Diagnostyka usterki</td><td className="text-center p-3 sm:p-4 text-[#6B8A00] font-bold">GRATIS*</td><td className="text-center p-3 sm:p-4 text-gray-400">48h</td><td className="text-center p-3 sm:p-4 text-gray-400">—</td><td className="text-center p-3 sm:p-4 text-gray-400">—</td></tr>
