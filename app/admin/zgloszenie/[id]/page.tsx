            ...
            <div className={`backdrop-blur-sm rounded-xl shadow border p-4 ${
              ...
              <div className="space-y-2">
                ...
                {repair.payment_status === 'succeeded' &&
                  ...
                  repair.payment_method !== 'proforma' && (
                  <div>
                ...
                {repair.payment_status === 'succeeded' && repair.payment_method === 'proforma' && (
                  <div>
                    <p className="text-xs text-gray-500">Metoda płatności</p>
                    <p className="text-sm font-medium text-gray-700">Przelew na podstawie pro formy</p>
                  </div>
                )}
                {repair.payment_status === 'proforma' && (
